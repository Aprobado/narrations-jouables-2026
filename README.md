...
Le dossier *Starter Assets* est une copie mise à jour pour Unity 6.4 de **Starter Assets: Character Controllers | URP** https://assetstore.unity.com/packages/essentials/starter-assets-character-controllers-urp-267961
...
3. Depuis le menu **Installs** du Hub, installez Unity 6.4 LTS
...
6. Dans la liste **Unity Registry**...
	...
	- Installez ProBuilder : com.unity.probuilder
	- Installez Terrain Tools : com.unity.terrain-tools
7. En haut à gauche de la fenêtre, cliquez sur **+ > Install package from git URL...**
8. Indiquez l'URL ```https://github.com/aprobado/narrations-jouables-2026.git```

## 2. Ajout du First Person Controller
...
## 3. Installation de l'environnement d'exemple
...
5. Ouvrez la scène *TerrainDemoScene* dans **Assets > TerrainDemoScene_URP > Scenes**
6. Supprimez ces GameObjects :
	- Main Camera
	- VirtualCameras
	- Timelines
7. Sélectionnez **EventSystem** et dans l'inspector, dans **Standalone Input Module**, cliquez **Replace with InputSystemUIInputModule**
8. Sauvegardez la scène.